    ...
    <>
      ...
      <Container>
        <TwoColumn>
          <LeftColumn>
            <Heading>
              Automated <span tw="text-blue-700">Web Accessibility</span> Solution for ADA & WCAG Compliance
            </Heading>
            <Paragraph>
          ...
          <RightColumn>
            <IllustrationContainer>
              <img tw="min-w-0 w-full max-w-lg xl:max-w-3xl p-3 top-0 right-0 " src={DesignIllustration} alt="Design Illustration" />
            </IllustrationContainer>
          </RightColumn>
        </TwoColumn>
        <DecoratorBlob1 />
