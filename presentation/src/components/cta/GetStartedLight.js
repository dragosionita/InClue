...
const Subheading = tw.h6`text-blue-500 opacity-75`;
const Heading = tw.h5`text-blue-500`;
...
const PrimaryLink = tw(
  Link
)`shadow text-gray-100 hocus:text-gray-300 bg-blue-500 hocus:bg-blue-700`;

const SecondaryLink = tw(
  Link
)`text-blue-500 hover:text-blue-600 bg-gray-100 hover:bg-gray-200`;

const DecoratorBlobContainer = tw.div`absolute inset-0 overflow-hidden rounded-lg`;
const DecoratorBlob1 = tw(
  SvgDecoratorBlob1
)`absolute bottom-0 left-0 w-80 h-80 transform -translate-x-20 translate-y-32 text-blue-500 opacity-5`;
const DecoratorBlob2 = tw(
  SvgDecoratorBlob1
)`absolute top-0 right-0 w-80 h-80 transform  translate-x-20 -translate-y-64 text-blue-500 opacity-5`;
export default ({
