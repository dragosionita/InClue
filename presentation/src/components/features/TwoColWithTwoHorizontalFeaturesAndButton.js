...
export default ({
  ...
  description = "By levering machine-learning, we are revolutionizing the way websites are made accessible and have set out to make the entire Internet accessible by 2025. InClue makes thousands of websites accessible in the time it used to take to make just one. The possibility of an accessible Internet is finally a practical reality. ",
  ...
  const defaultFeatures = [
    {
      Icon: BriefcaseIcon,
      title: "Screen-Reader powered by AI",
      description: "Automatic Screen-Reader adjustments powered by AI",
      iconContainerCss: tw`bg-teal-300 text-teal-800`
    },
    {
      Icon: MoneyIcon,
      title: "Keyboard Navigation powered by AI",
      description: "Automatic Keyboard Navigation adjustments powered by AI",
