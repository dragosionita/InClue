  ...
  data: {
    ...
    orientationOptions: [
      ...
      },
      {
        ...
        svg: `<svg width="20px" height="20px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path fill="#fff" stroke="#000" stroke-width="30px" d="M123.193 29.635L121 406.18l84.31-82.836 65.87 159.02 67.5-27.96-65.87-159.02L391 294.342z"/></svg>`
      },
      {
        name: "hideImages",
        title: "Hide Images",
